        ...
        <div className="bg-black text-white  py-6 px-6 md:px-70">
          <div className="grid md:grid-cols-3 gap-8 items-center">
            ...
            <div className="md:col-span-1 text-sm md:px-6">
              ...
              Minor electrical and mechanical work refers to small-scale repairs and adjustments performed on a vehicle’s systems to ensure smooth and safe operation. This includes tasks like fixing faulty lights, replacing fuses, repairing power windows, adjusting door locks, fixing loose wiring, or addressing minor issues with the horn, wipers, or indicators.
              </p>
              <p className="text-gray-300 mb-4">
              On the mechanical side, it may involve tightening belts, replacing small components like filters or hoses, checking fluid levels, or addressing minor leaks and noises. These services are typically quick and cost-effective but play a crucial role in maintaining the overall health of the vehicle. Regular attention to these small issues prevents them from developing into major problems, improves driving comfort, and ensures all essential systems function properly. It also contributes to the long-term reliability and safety of the vehicle.
              </p>
            ...
            <div className="relative">
              <img
                src="https://media.istockphoto.com/id/1286861017/photo/auto-electrician.jpg?s=612x612&w=0&k=20&c=gEdvgj0Gd3Ri5SvgHIobnVNOEw_UMIStlu-mTML5wYI="
                alt="Ceramic Coating"
              ...
              <div className="md:absolute md:bottom-[-20px] md:left-[-40px] absolute bottom-[-20px] left-[80px] border-4 border-white rounded-lg">
                <img
                  src="https://media.istockphoto.com/id/1428271853/photo/mechanic-inspecting-engine-at-garage-workshop.jpg?s=612x612&w=0&k=20&c=dAkLigq3R9iJboJk5477d1gprZbv2IENLbjm5IYg_xI="
                  alt="Detailing"
            ...
            <div className="md:col-span-1">
              <div className="mb-8 ">
                ...
                Minor electrical and mechanical work provides invisible and durable protection by addressing small issues before they escalate into larger, more costly problems. Fixing components like wiring, fuses, or belts helps ensure the vehicle’s systems run smoothly and efficiently. These repairs often go unnoticed but play a key role in preserving the car’s performance and preventing further damage. Regular maintenance ensures that critical parts are functioning optimally, extending the life of the vehicle and maintaining its reliability over time.
                </p>
              </div>
              <div className="">
                <img
                  src="https://media.istockphoto.com/id/1766280570/photo/mechanic-inspecting-engine-at-garage-workshop.jpg?s=612x612&w=0&k=20&c=D8QZ1TqDrR6CSS-XAYQx2qNsDpPsIsyTqKZU_Fg8fI4="
              ...
              <div>
                ...
                Minor electrical and mechanical work helps preserve the vehicle’s value and appearance by ensuring all systems operate properly and are in good condition. Fixing small issues like faulty lights, worn-out belts, or malfunctioning windows prevents further damage, keeping the car in top shape. This attention to detail not only enhances the vehicle's functionality but also contributes to its overall aesthetic appeal, maintaining its resale value and making it more attractive to potential buyers. Regular care also helps retain a well-maintained, polished look, reflecting good ownership and care.
                </p>
              </div>
            </div>
          </div>
