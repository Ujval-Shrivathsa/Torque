...
const benefits = [
  ...
  {
    icon: "https://ocdetailmn.com/wp-content/uploads/2024/02/icon_umbrella.svg",
    title: "Enhances Driving Experience",
  ...
  return (
    <div className="bg-black text-white overflow-x-hidden min-h-screen">
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0,0,0,1.1), rgba(0,0,0,0.5)), url('https://img.freepik.com/premium-photo/worker-wipes-steering-wheel-car-dry-cleaning-interior-washing-detailing-studio_199620-12955.jpg?ga=GA1.1.1515336155.1743059816&semt=ais_hybrid&w=740')`,
