  ...
  return (
    <div className="bg-black text-white overflow-x-hidden min-h-screen">
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0,0,0,0.8), rgba(0,0,0,0.5)), url('https://img.freepik.com/free-photo/auto-service-salon-doign-car-wrapping_23-2149593880.jpg?ga=GA1.1.1515336155.1743059816&semt=ais_hybrid&w=740')`,
